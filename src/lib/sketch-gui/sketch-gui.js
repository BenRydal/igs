...
export class SketchGUI {
  ...
  update2D() {
    ...
    if (timeline.overTimeline(this.sk.mouseX) && !this.sk.handle3D.getIs3DMode())
      this.drawLongSlicer()
  ...
  update3D() {
    ...
    if (this.sk.handle3D.getIs3DMode() && timeline.overTimeline(this.sk.mouseX) && this.sk.mouseY > this.sk.height) {
